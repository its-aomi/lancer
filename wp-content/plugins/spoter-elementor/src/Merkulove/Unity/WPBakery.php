...
final class WPBakery {
    ...
    public function editor_styles() {
        ...
        wp_enqueue_style( 'mdp-spoter-elementor-wpbakery-admin', Plugin::get_url() . 'src/Merkulove/Unity/assets/css/wpbakery-admin' . Plugin::get_suffix() . '.css', [], Plugin::get_version() );
    ...
    public function load_addons() {
        ...
        $path = Plugin::get_path() . 'src/Merkulove/SpoterElementor/WPBakery/addons/';
    ...
    public function load_templates() {
        ...
        $path = Plugin::get_path() . 'src/Merkulove/SpoterElementor/WPBakery/templates/';
