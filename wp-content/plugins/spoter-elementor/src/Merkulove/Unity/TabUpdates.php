...
final class TabUpdates extends Tab {
    ...
    private function __construct() {
        ...
        /** Reset Settings. */
        add_action( 'wp_ajax_check_updates_spoter_elementor', [ __CLASS__, 'ajax_check_updates' ] );
	...
	public function add_settings() {
        ...
        add_settings_field( 'check_updates', esc_html__( 'Check for updates:', 'spoter-elementor' ), [ $this, 'check_updates' ], $group, $section );

        /** Check SSL */
        add_settings_field( 'check_ssl', esc_html__( 'SSL verification:', 'spoter-elementor' ), [ $this, 'check_ssl' ], $group, $section );
    ...
    public function check_updates() {
        ...
        UI::get_instance()->render_button(
            esc_html__( 'Clear cache', 'spoter-elementor' ),
            '',
            'autorenew',
            [
                "name" => 'mdp_spoter_elementor_' . self::TAB_SLUG . '_settings' . "[check_updates]",
                "id" => "mdp-updates-btn",
    ...
    public function check_ssl() {
        ...
        UI::get_instance()->render_switcher(
            ...
            esc_html__( 'SSL verification', 'spoter-elementor' ),
            esc_html__( 'Enable to activate the SSL check when receiving updates', 'spoter-elementor' ),
            [
                "name" => 'mdp_spoter_elementor_' . self::TAB_SLUG . '_settings' . "[check_ssl]",
            ]
