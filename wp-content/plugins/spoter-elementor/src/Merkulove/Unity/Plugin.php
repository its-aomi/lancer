...
final class Plugin {
    ...
    private function initialization() {
        ...
        /** Full path to main plugin file. */
        self::$plugin_file = dirname( dirname( dirname( __DIR__ ) ) ) . '/spoter-elementor.php';
        ...
        if ( in_array( self::$type, [ 'elementor', 'wpbakery' ] ) ) {
            ...
            self::$menu_bases[] = 'elementor_page_mdp_spoter_elementor_settings';
            self::$menu_bases[] = 'settings_page_mdp_spoter_elementor_settings';

        /** For general WordPress plugins. */
        } else {

            self::$menu_bases[] = 'toplevel_page_mdp_spoter_elementor_settings';
            self::$menu_bases[] = 'spoter_elementor_page_mdp_spoter_elementor_settings';
    ...
    private function add_general_tab() {
        ...
        self::$tabs['general'] = [
            ...
            'label'         => esc_html__( 'General', 'spoter-elementor' ),
            'title'         => esc_html__( 'General Settings', 'spoter-elementor' ),
            'show_title'    => true,
            'icon'          => 'tune',
            'fields'        => []
        ];
    ...
    private function add_custom_css_tab() {
        ...
        self::$tabs['custom_css'] = [
            ...
            'label'         => esc_html__( 'Custom CSS', 'spoter-elementor' ),
            'title'         => esc_html__( 'Custom CSS', 'spoter-elementor' ),
            'show_title'    => true,
            'icon'          => 'code',
            'fields'        => [
                'custom_css' => [
                    'type'              => 'css_editor',
                    'description'       => esc_html__( 'Add custom CSS here.', 'spoter-elementor' ),
    ...
    private function add_assignments_tab() {
        ...
        self::$tabs['assignments'] = [
            ...
            'label'         => esc_html__( 'Assignments', 'spoter-elementor' ),
            'title'         => esc_html__( 'Assignments Settings', 'spoter-elementor' ),
            'show_title'    => true,
            'icon'          => 'flag',
            'assignments'   => [
    ...
    private function add_activation_tab() {
        ...
        self::$tabs['activation'] = [
            ...
            'label'         => esc_html__( 'Activation', 'spoter-elementor' ),
            'title'         => esc_html__( 'Plugin Activation', 'spoter-elementor' ),
            'show_title'    => false,
            'icon'          => 'vpn_key',
            'fields'        => [
    ...
    private function add_status_tab() {
        ...
        self::$tabs['status'] = [
            ...
            'label'         => esc_html__( 'Status', 'spoter-elementor' ),
            'title'         => esc_html__( 'System Status', 'spoter-elementor' ),
            'show_title'    => true,
    ...
    private function add_updates_tab() {
        ...
        self::$tabs['updates'] = [
            ...
            'label'         => esc_html__( 'Updates', 'spoter-elementor' ),
            'title'         => esc_html__( 'Updates', 'spoter-elementor' ),
            'show_title'    => true,
            'icon'          => 'update',
            'fields'        => [
                'check_ssl' => [
    ...
    private function add_migration_tab() {
        ...
        self::$tabs['migration'] = [
            ...
            'label'         => esc_html__( 'Migration', 'spoter-elementor' ),
            'title'         => esc_html__( 'Migration Settings', 'spoter-elementor' ),
            'show_title'    => true,
            'icon'          => 'multiple_stop',
            'fields'        => [
                'delete_plugin' => [
                    'type'              => 'select',
                    'options'           => [
                        'plugin'                => esc_html__( 'Delete plugin only', 'spoter-elementor' ),
                        'plugin+settings'       => esc_html__( 'Delete plugin and settings', 'spoter-elementor' ),
                        'plugin+settings+data'  => esc_html__( 'Delete plugin, settings and data', 'spoter-elementor' ),
                    ],
                    'default'           => 'plugin',
                ]
            ]
    ...
    public static function get_plugin_file() {
        ...
        return dirname( dirname( dirname( __DIR__ ) ) ) . '/spoter-elementor.php';
