...
"use strict";
/*!*******************************************************!*\
  !*** ./wp-content/plugins/spoter-elementor/js/source/exp.js ***!
  \*******************************************************/
...
( function ( $ ) {
    ...
    $( document ).ready( function () {
        ...
        const { ajaxURL, nonce } = mdpSpoterElementor;
            ...
            $exportButton.addEventListener('click', (e) => {
                ...
                xhr.onload = () => {
                    ...
                    if (xhr.status === 200) {
                        ...
                        // Download file
                        let fileName = 'spoter-elementor-settings.json'
                ...
                xhr.send(`action=export_settings_spoter_elementor&nonce=${nonce}`);
        ...
        function readFile( file ) {
            ...
            reader.onload = ( function( theFile ) {
                ...
                return function( e ) {
                    ...
                    xhr.send(`action=import_settings_spoter_elementor&nonce=${ nonce }&import=${ encodeURIComponent( JSON.stringify( json ) ) }`);
