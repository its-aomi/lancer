...
( function ( $ ) {
    ...
    $( document ).ready( function () {
        ...
        let mdpSpoterElementor = window.mdpSpoterElementor;
        ...
        $subscribeBtn.on( 'click', function (e) {
            ...
            if ( $mail.val().length > 0 && window.MerkulovMaterial[mailIndex].valid) {
                ...
                $.ajax({
                    type: "GET",
                    url: `${ mdpSpoterElementor.restBase }spoter-elementor/v2/subscribe`,
                    crossDomain: true,
        ...
        $checkUpdatesBtn.on( 'click', function ( e ) {
            ...
            let data = {
                action: 'check_updates_spoter_elementor',
                nonce: mdpSpoterElementor.nonce,
                checkUpdates: true
            };

            /** Do AJAX request. */
            $.post( mdpSpoterElementor.ajaxURL, data, function( response ) {
