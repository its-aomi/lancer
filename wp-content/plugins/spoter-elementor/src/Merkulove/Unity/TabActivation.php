...
final class TabActivation extends Tab {
    ...
    public function add_settings() {
        ...
        /** Activation Tab. */
        register_setting( 'SpoterElementorActivationOptionsGroup', 'envato_purchase_code_' . EnvatoItem::get_instance()->get_id() );
        add_settings_section( 'mdp_spoter_elementor_settings_page_activation_section', '', null, 'SpoterElementorActivationOptionsGroup' );
    ...
    public function do_settings() {
        ...
        /** Render fields. */
        settings_fields( 'SpoterElementorActivationOptionsGroup' );
        do_settings_sections( 'SpoterElementorActivationOptionsGroup' );
	...
	public function display_status() {
		...
		$activation_tab = admin_url( 'admin.php?page=mdp_spoter_elementor_settings&tab=activation' );
		?>

        <hr class="mdc-list-divider">
        <h6 class="mdc-list-group__subheader"><?php esc_html_e( 'CodeCanyon License', 'spoter-elementor' ); ?></h6>
		...
		<?php if ( $this->is_activated() ) : ?>
            <a class="mdc-list-item mdp-activation-status activated" href="<?php echo esc_url( $activation_tab ); ?>">
                ...
                <span class="mdc-list-item__text"><?php esc_html_e( 'Activated', 'spoter-elementor' ); ?></span>
            </a>
		<?php else : ?>
            <a class=" mdc-list-item mdp-activation-status not-activated" href="<?php echo esc_url( $activation_tab ); ?>">
                ...
                <span class="mdc-list-item__text"><?php esc_html_e( 'Not Activated', 'spoter-elementor' ); ?></span>
            </a>
		<?php endif;
	...
	public function render_subscribe() {
        ...
        <div class="mdp-subscribe-form">
            ...
            <h3><?php esc_html_e( 'Subscribe to newsletter', 'spoter-elementor' ); ?></h3>
            <p><?php esc_html_e( 'Sign up for the newsletter to be the first to know about news and discounts.', 'spoter-elementor' ); ?></p>
            <p class="mdp-subscribe-form-message"
               data-success="<?php esc_html_e( 'Hurray! We received your Subscription request. Check your inbox for an email from us.', 'spoter-elementor' ); ?>"
               data-warn="<?php esc_html_e( 'Oh! Sorry, but we cannot send messages to this email.', 'spoter-elementor' ); ?>"
               data-error="<?php esc_html_e( 'Oops! Something went wrong. Please try later.', 'spoter-elementor' ); ?>"
            ></p>
            ...
            UI::get_instance()->render_input(
                '',
                esc_html__( 'Your Name', 'spoter-elementor' ),
                '',
                [
            ...
            UI::get_instance()->render_input(
                '',
                esc_html__( 'Your E-Mail', 'spoter-elementor' ),
                '',
                [
            ...
            UI::get_instance()->render_button(
                esc_html__( 'Subscribe', 'spoter-elementor' ),
                '',
                false,
                [
                    "name"  => "mdp-subscribe",
	...
	public function render_form() {
        ...
        <div class="mdp-activation-form">
            <h3><?php esc_html_e( 'Plugin Activation', 'spoter-elementor' ); ?></h3>
            <?php

            /** Render input. */
            UI::get_instance()->render_input(
                $purchase_code,
                esc_html__( 'Purchase code', 'spoter-elementor'),
                esc_html__( 'Enter your CodeCanyon purchase code. Allowed only one Purchase Code per website.', 'spoter-elementor' ),
                [
    ...
    public function render_FAQ() {
        ...
        <div class="mdp-activation-faq">
            <div class="mdc-accordion" data-mdp-accordion="showfirst: true">
                ...
                <h3><?php esc_html_e( 'Activation FAQ\'S', 'spoter-elementor' ); ?></h3>

                <div class="mdc-accordion-title">
                    <i class="material-icons">help</i>
                    <span class="mdc-list-item__text"><?php esc_html_e( 'Where is my Purchase Code?', 'spoter-elementor' ); ?></span>
                </div>
                <div class="mdc-accordion-content">
                    <p><?php esc_html_e( 'The purchase code is a unique combination of characters that confirms that you bought the plugin. You can find your purchase code in ', 'spoter-elementor' ); ?>
                        <a href="https://1.envato.market/cc-downloads" target="_blank"><?php esc_html_e( 'your account', 'spoter-elementor' );?></a>
                        <?php esc_html_e( ' on the CodeCanyon. Learn more about ', 'spoter-elementor' ); ?>
                        <a href="https://help.market.envato.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code-" target="_blank"><?php esc_html_e( 'How to find your purchase code', 'spoter-elementor' );?></a>
                        <?php esc_html_e( ' .', 'spoter-elementor');?>
                    </p>
                </div>

                <div class="mdc-accordion-title">
                    <i class="material-icons">help</i>
                    <span class="mdc-list-item__text"><?php esc_html_e( 'Can I use one Purchase Code on multiple sites?', 'spoter-elementor' ); ?></span>
                </div>
                <div class="mdc-accordion-content">
                    <p>
                        <?php esc_html_e( 'No, this is prohibited by license terms. You can use the purchase code on only one website at a time. Learn more about ', 'spoter-elementor' ); ?>
                        <a href="https://1.envato.market/KYbje" target="_blank"><?php esc_html_e( 'Envato License', 'spoter-elementor' );?></a>
                        <?php esc_html_e( ' terms. ', 'spoter-elementor' ); ?>
                    </p>
                </div>

                <div class="mdc-accordion-title">
                    <i class="material-icons">help</i>
                    <span class="mdc-list-item__text"><?php esc_html_e( 'What are the benefits of plugin activation?', 'spoter-elementor' ); ?></span>
                </div>
                <div class="mdc-accordion-content">
                    <p>
                        <?php esc_html_e( 'Activation of the plugin allows you to use all the functionality of the plugin on your site. In addition, in some cases, activating the plugin allows you to access additional features and capabilities of the plugin. Also, using an authored version of the plugin, you can be sure that you will not violate the license.', 'spoter-elementor' ); ?>
                    </p>
                </div>

                <div class="mdc-accordion-title">
                    <i class="material-icons">help</i>
                    <span class="mdc-list-item__text"><?php esc_html_e( 'What should I do if my Purchase Code does not work?', 'spoter-elementor' ); ?></span>
                </div>
                <div class="mdc-accordion-content">
                    <p>
                        <?php esc_html_e( 'There are several reasons why the purchase code may not work on your site. Learn more why your ', 'spoter-elementor' ); ?>
                        <a href="https://merkulove.zendesk.com/hc/en-us/articles/360006100998-Troubleshooting-of-the-plugin-activation" target="_blank"><?php esc_html_e( 'Purchase Code is Not Working', 'spoter-elementor' );?></a>
                        <?php esc_html_e( ' .', 'spoter-elementor');?>
                    </p>
                </div>
