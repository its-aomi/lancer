...
final class PluginHelper {
	...
	public function add_row_meta( $links, $file ) {
		...
		$stars = esc_html__( 'Rate this plugin:', 'spoter-elementor' );
    ...
    public static function load_textdomain() {
        ...
        load_plugin_textdomain( 'spoter-elementor', false, Plugin::get_path() . '/languages/' );
