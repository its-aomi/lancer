...
final class ReporterWordPress {
	...
	public function get_title() {
        ...
        return esc_html__( 'WordPress Environment', 'spoter-elementor' );
	...
	public function get_fields() {
		...
		return [
			'version'               => esc_html__( 'Version', 'spoter-elementor' ),
			'site_url'              => esc_html__( 'Site URL', 'spoter-elementor' ),
			'home_url'              => esc_html__( 'Home URL', 'spoter-elementor' ),
			'is_multisite'          => esc_html__( 'WP Multisite', 'spoter-elementor' ),
			'max_upload_size'       => esc_html__( 'Max Upload Size', 'spoter-elementor' ),
			'memory_limit'          => esc_html__( 'Memory limit', 'spoter-elementor' ),
			'permalink_structure'   => esc_html__( 'Permalink Structure', 'spoter-elementor' ),
			'language'              => esc_html__( 'Language', 'spoter-elementor' ),
			'timezone'              => esc_html__( 'Timezone', 'spoter-elementor' ),
			'admin_email'           => esc_html__( 'Admin Email', 'spoter-elementor' ),
			'debug_mode'            => esc_html__( 'Debug Mode', 'spoter-elementor' ),
		];
	...
	public function get_memory_limit() {
		...
		if ( $memory_limit_bytes < $min_recommended_bytes ) {
			$result['recommendation'] = esc_html__( 'We recommend setting memory to at least 64M. For more information, ask your hosting provider.', 'spoter-elementor' );
	...
	public function get_is_multisite() {
		...
		return [
			'value' => is_multisite() ? esc_html__( 'Yes', 'spoter-elementor' ) : esc_html__( 'No', 'spoter-elementor' )
		];
	...
	public function get_permalink_structure() {
		...
		if ( ! $structure ) {
			$structure = esc_html__( 'Plain', 'spoter-elementor' );
		}
	...
	public function get_debug_mode() {
		...
		return [
			'value' => WP_DEBUG ? esc_html__( 'Active', 'spoter-elementor' ) : esc_html__( 'Inactive', 'spoter-elementor' )
		];
