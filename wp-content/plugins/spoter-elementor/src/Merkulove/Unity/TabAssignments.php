...
namespace Merkulove\SpoterElementor\Unity;
...
final class TabAssignments extends Tab  {
	...
	public function add_admin_scripts() {
        ...
        wp_enqueue_script( 'mdp-spoter-elementor-assignments', Plugin::get_url() . 'src/Merkulove/Unity/assets/js/assignments' . Plugin::get_suffix() . '.js', [ 'jquery-datetimepicker-full', 'jquery' ], Plugin::get_version(), true );
	...
	public function render_assignments() {
        ...
        <input type='hidden'
               id="mdp-assignInput"
               name='<?php esc_attr_e( 'mdp_spoter_elementor_' . self::TAB_SLUG . '_settings' ); ?>[assignments]'
        ...
        <div id="mdp-assign-box">
            ...
            <div class="mdp-all-fields">
                ...
                <div class="mdp-panel mdp-panel-box mdp-matching-method mdp-margin <?php $this->is_need_to_hide( 'matching_method' ); ?>">
                    <h4><?php esc_html_e( 'Matching Method', 'spoter-elementor' ); ?></h4>
                    <p><?php esc_html_e( 'Should all or any assignments be matched?', 'spoter-elementor' ); ?></p>
                    <div class="mdp-button-group mdp-button-group mdp-matchingMethod" data-mdp-button-radio="">
                        <button class="mdp-button mdp-button-success mdp-button-small mdp-all mdp-active"><?php esc_html_e( 'ALL', 'spoter-elementor' ); ?></button>
                        <button class="mdp-button mdp-button-success mdp-button-small mdp-any"><?php esc_html_e( 'ANY', 'spoter-elementor' ); ?></button>
                    </div>
	                <p><?php esc_html_e('The plugin is enabled on the page if ALL the selected rules matched, or if ANY of the selected rules matched', 'spoter-elementor' ); ?></p>
                </div>

                <div class="mdp-panel mdp-panel-box mdp-wp-content mdp-margin <?php $this->is_need_to_hide( 'wordpress_content' ); ?>">

                    <h4><?php esc_html_e( 'WordPress Content', 'spoter-elementor' ); ?></h4>

                    <div class="mdp-button-group mdp-button-group" data-mdp-button-radio="">
                        <button class="mdp-button mdp-button-primary mdp-button-small mdp-ignore mdp-active"><?php esc_html_e( 'Ignore', 'spoter-elementor' ); ?></button>
                        <button class="mdp-button mdp-button-success mdp-button-small mdp-include"><?php esc_html_e( 'Include', 'spoter-elementor' ); ?></button>
                        <button class="mdp-button mdp-button-danger mdp-button-small mdp-exclude"><?php esc_html_e( 'Exclude', 'spoter-elementor' ); ?></button>
                    </div>

                    <div class="mdp-wp-content-box">
                        <p class="mdp-margin-bottom-remove mdp-margin-top">
							<?php esc_html_e( 'Select on what page types or categories the assignment should be active.', 'spoter-elementor' ); ?>
                        </p>
                        <label>
                ...
                <div class="mdp-panel mdp-panel-box mdp-home-page mdp-margin <?php $this->is_need_to_hide( 'home_page' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Home Page', 'spoter-elementor' ); ?></h4>
                ...
                <div class="mdp-panel mdp-panel-box mdp-menu-items mdp-margin <?php $this->is_need_to_hide( 'menu_items' ); ?>">
                    <h4><?php esc_html_e( 'Menu Items', 'spoter-elementor' ); ?></h4>
                    <div class="mdp-button-group mdp-button-group" data-mdp-button-radio="">
                        <button class="mdp-button mdp-button-primary mdp-button-small mdp-ignore mdp-active"><?php esc_html_e( 'Ignore', 'spoter-elementor' ); ?></button>
                        <button class="mdp-button mdp-button-success mdp-button-small mdp-include"><?php esc_html_e( 'Include', 'spoter-elementor' ); ?></button>
                        <button class="mdp-button mdp-button-danger mdp-button-small mdp-exclude"><?php esc_html_e( 'Exclude', 'spoter-elementor' ); ?></button>
                    ...
                    <div class="mdp-menuitems-selection">
                        <p class="mdp-margin-bottom-remove mdp-margin-top"><?php esc_html_e( 'Select the menu items to assign to.', 'spoter-elementor' ); ?></p>
                        <label>
                ...
                <div class="mdp-panel mdp-panel-box mdp-date-time mdp-margin <?php $this->is_need_to_hide( 'date_time' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Date & Time', 'spoter-elementor' ); ?></h4>
                    ...
                    <div class="mdp-period-picker-box">
                        ...
                        <p>
							<?php esc_html_e( 'The date and time assignments use the date/time of your servers, not that of the visitors system.', 'spoter-elementor' ); ?>
                            <br>
							<?php esc_html_e( 'Current date/time:', 'spoter-elementor' ); ?>
                ...
                <div class="mdp-panel mdp-panel-box mdp-languages mdp-margin <?php $this->is_need_to_hide( 'languages' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Languages', 'spoter-elementor' ); ?></h4>
                    ...
                    <div class="languages-box">
                        <p class="mdp-margin-remove-bottom mdp-margin-top"><?php esc_html_e( 'Select the languages to assign to.', 'spoter-elementor' ); ?></p>
                ...
                <div class="mdp-panel mdp-panel-box mdp-user-roles mdp-margin <?php $this->is_need_to_hide( 'user_roles' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'User Roles', 'spoter-elementor' ); ?></h4>
                    ...
                    <div class="user-roles-box">
                        <p class="mdp-margin-remove-bottom mdp-margin-top"><?php esc_html_e( 'Select the user roles to assign to.', 'spoter-elementor' ); ?></p>
                        <label>
                ...
                <div class="mdp-panel mdp-panel-box mdp-url mdp-margin <?php $this->is_need_to_hide( 'url' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'URL', 'spoter-elementor' ); ?></h4>
                    ...
                    <div class="mdp-url-box">
                        <p class="mdp-margin-bottom-remove mdp-margin-top">
							<?php esc_html_e( 'Enter (part of) the URLs to match.', 'spoter-elementor' ); ?><br>
							<?php esc_html_e( 'Use a new line for each different match.', 'spoter-elementor' ); ?>
                        </p>
                ...
                <div class="mdp-panel mdp-panel-box mdp-devices mdp-margin <?php $this->is_need_to_hide( 'devices' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Devices', 'spoter-elementor' ); ?></h4>
                    ...
                    <div class="mdp-devices-box">
                        <p class="mdp-margin-remove-bottom mdp-margin-top"><?php esc_html_e( 'Select the devices to assign to. Keep in mind that device detection is not always 100% accurate. Users can setup their device to mimic other devices.', 'spoter-elementor' ); ?></p>
                        <label>
                        <select class="devices chosen-select" multiple="">
                            <option value=""></option>
                            <option value="desktop"><?php esc_html_e( 'Desktop', 'spoter-elementor' ); ?></option>
                            <option value="tablet"><?php esc_html_e( 'Tablet', 'spoter-elementor' ); ?></option>
                            <option value="mobile"><?php esc_html_e( 'Mobile', 'spoter-elementor' ); ?></option>
                        </select>
                        </label>
                    </div>
                ...
                <div class="mdp-panel mdp-panel-box mdp-os mdp-margin <?php $this->is_need_to_hide( 'operating_systems' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Operating Systems', 'spoter-elementor' ); ?></h4>
                    ...
                    <div class="mdp-os-box">
                        <p class="mdp-margin-remove-bottom mdp-margin-top"><?php esc_html_e( 'Select the operating systems to assign to. Keep in mind that operating system detection is not always 100% accurate. Users can setup their browser to mimic other operating systems.', 'spoter-elementor' ); ?></p>
                        <!--suppress HtmlFormInputWithoutLabel -->
                        <select class="os chosen-select" multiple="">
                            <option value=""></option>
                            <option value="Windows"><?php esc_html_e( 'Windows (All)', 'spoter-elementor' ); ?></option>
                            <option value="Windows nt 10.0"><?php esc_html_e( 'Windows 10', 'spoter-elementor' ); ?></option>
                            <option value="Windows nt 6.2"><?php esc_html_e( 'Windows 8', 'spoter-elementor' ); ?></option>
                            <option value="Windows nt 6.1"><?php esc_html_e( 'Windows 7', 'spoter-elementor' ); ?></option>
                            <option value="Windows nt 6.0"><?php esc_html_e( 'Windows Vista', 'spoter-elementor' ); ?></option>
                            <option value="Windows nt 5.2"><?php esc_html_e( 'Windows Server 2003', 'spoter-elementor' ); ?></option>
                            <option value="Windows nt 5.1"><?php esc_html_e( 'Windows XP', 'spoter-elementor' ); ?></option>
                            <option value="Windows nt 5.01"><?php esc_html_e( 'Windows 2000 sp1', 'spoter-elementor' ); ?></option>
                            <option value="Windows nt 5.0"><?php esc_html_e( 'Windows 2000', 'spoter-elementor' ); ?></option>
                            <option value="Windows nt 4.0"><?php esc_html_e( 'Windows NT 4.0', 'spoter-elementor' ); ?></option>
                            <option value="Win 9x 4.9"><?php esc_html_e( 'Windows Me', 'spoter-elementor' ); ?></option>
                            <option value="Windows 98"><?php esc_html_e( 'Windows 98', 'spoter-elementor' ); ?></option>
                            <option value="Windows 95"><?php esc_html_e( 'Windows 95', 'spoter-elementor' ); ?></option>
                            <option value="Windows ce"><?php esc_html_e( 'Windows CE', 'spoter-elementor' ); ?></option>
                            <option value="#(Mac OS|Mac_PowerPC|Macintosh)#"><?php esc_html_e( 'Mac OS (All)', 'spoter-elementor' ); ?></option>
                            <option value="Mac OS X"><?php esc_html_e( 'Mac OSX (All)', 'spoter-elementor' ); ?></option>
                            <option value="Mac OS X 10.11"><?php esc_html_e( 'Mac OSX El Capitan', 'spoter-elementor' ); ?></option>
                            <option value="Mac OS X 10.10"><?php esc_html_e( 'Mac OSX Yosemite', 'spoter-elementor' ); ?></option>
                            <option value="Mac OS X 10.9"><?php esc_html_e( 'Mac OSX Mavericks', 'spoter-elementor' ); ?></option>
                            <option value="Mac OS X 10.8"><?php esc_html_e( 'Mac OSX Mountain Lion', 'spoter-elementor' ); ?></option>
                            <option value="Mac OS X 10.7"><?php esc_html_e( 'Mac OSX Lion', 'spoter-elementor' ); ?></option>
                            <option value="Mac OS X 10.6"><?php esc_html_e( 'Mac OSX Snow Leopard', 'spoter-elementor' ); ?></option>
                            <option value="Mac OS X 10.5"><?php esc_html_e( 'Mac OSX Leopard', 'spoter-elementor' ); ?></option>
                            <option value="Mac OS X 10.4"><?php esc_html_e( 'Mac OSX Tiger', 'spoter-elementor' ); ?></option>
                            <option value="Mac OS X 10.3"><?php esc_html_e( 'Mac OSX Panther', 'spoter-elementor' ); ?></option>
                            <option value="Mac OS X 10.2"><?php esc_html_e( 'Mac OSX Jaguar', 'spoter-elementor' ); ?></option>
                            <option value="Mac OS X 10.1"><?php esc_html_e( 'Mac OSX Puma', 'spoter-elementor' ); ?></option>
                            <option value="Mac OS X 10.0"><?php esc_html_e( 'Mac OSX Cheetah', 'spoter-elementor' ); ?></option>
                            <option value="#(Mac_PowerPC|Macintosh)#"><?php esc_html_e( 'Mac OS (classic)', 'spoter-elementor' ); ?></option>
                            <option value="#(Linux|X11)#"><?php esc_html_e( 'Linux', 'spoter-elementor' ); ?></option>
                            <option value="OpenBSD"><?php esc_html_e( 'Open BSD', 'spoter-elementor' ); ?></option>
                            <option value="SunOS"><?php esc_html_e( 'Sun OS', 'spoter-elementor' ); ?></option>
                            <option value="QNX"><?php esc_html_e( 'QNX', 'spoter-elementor' ); ?></option>
                            <option value="BeOS"><?php esc_html_e( 'BeOS', 'spoter-elementor' ); ?></option>
                            <option value="OS/2"><?php esc_html_e( 'OS/2', 'spoter-elementor' ); ?></option>
                        </select>
                    </div>
                ...
                <div class="mdp-panel mdp-panel-box mdp-browsers mdp-margin <?php $this->is_need_to_hide( 'browsers' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Browsers', 'spoter-elementor' ); ?></h4>
                    ...
                    <div class="mdp-browsers-box">
                        <p class="mdp-margin-remove-bottom mdp-margin-top"><?php esc_html_e( 'Select the browsers to assign to. Keep in mind that browser detection is not always 100% accurate. Users can setup their browser to mimic other browsers.', 'spoter-elementor' ); ?></p>

                        <div class="mdp-widget-manager-control-box">
                            <p><?php esc_html_e( 'Browsers:', 'spoter-elementor' ); ?></p>
                            <div>
                                <!--suppress HtmlFormInputWithoutLabel -->
                                <select class="browsers chosen-select" multiple="">
                                    <option value=""></option>
                                    <option value="Chrome"><?php esc_html_e( 'Chrome (All)', 'spoter-elementor' ); ?></option>
                                    <option value="#Chrome/(6[1-9]|70)\.#"><?php esc_html_e( 'Chrome 61-70', 'spoter-elementor' ); ?></option>
                                    <option value="#Chrome/(5[1-9]|60)\.#"><?php esc_html_e( 'Chrome 51-60', 'spoter-elementor' ); ?></option>
                                    <option value="#Chrome/(4[1-9]|50)\.#"><?php esc_html_e( 'Chrome 41-50', 'spoter-elementor' ); ?></option>
                                    <option value="#Chrome/(3[1-9]|40)\.#"><?php esc_html_e( 'Chrome 31-40', 'spoter-elementor' ); ?></option>
                                    <option value="#Chrome/(2[1-9]|30)\.#"><?php esc_html_e( 'Chrome 21-30', 'spoter-elementor' ); ?></option>
                                    <option value="#Chrome/(1[1-9]|20)\.#"><?php esc_html_e( 'Chrome 11-20', 'spoter-elementor' ); ?></option>
                                    <option value="#Chrome/([1-9]|10)\.#"><?php esc_html_e( 'Chrome 1-10', 'spoter-elementor' ); ?></option>
                                    <option value="Firefox"><?php esc_html_e( 'Firefox (All)', 'spoter-elementor' ); ?></option>
                                    <option value="#Firefox/(6[1-9]|70)\.#"><?php esc_html_e( 'Firefox 61-70', 'spoter-elementor' ); ?></option>
                                    <option value="#Firefox/(5[1-9]|60)\.#"><?php esc_html_e( 'Firefox 51-60', 'spoter-elementor' ); ?></option>
                                    <option value="#Firefox/(4[1-9]|50)\.#"><?php esc_html_e( 'Firefox 41-50', 'spoter-elementor' ); ?></option>
                                    <option value="#Firefox/(3[1-9]|40)\.#"><?php esc_html_e( 'Firefox 31-40', 'spoter-elementor' ); ?></option>
                                    <option value="#Firefox/(2[1-9]|30)\.#"><?php esc_html_e( 'Firefox 21-30', 'spoter-elementor' ); ?></option>
                                    <option value="#Firefox/(1[1-9]|20)\.#"><?php esc_html_e( 'Firefox 11-20', 'spoter-elementor' ); ?></option>
                                    <option value="#Firefox/([1-9]|10)\.#"><?php esc_html_e( 'Firefox 1-10', 'spoter-elementor' ); ?></option>
                                    <option value="MSIE"><?php esc_html_e( 'Internet Explorer (All)', 'spoter-elementor' ); ?></option>
                                    <option value="MSIE Edge"><?php esc_html_e( 'Internet Explorer Edge', 'spoter-elementor' ); ?></option>
                                    <option value="Edge/15"><?php esc_html_e( 'Edge 15', 'spoter-elementor' ); ?></option>
                                    <option value="Edge/14"><?php esc_html_e( 'Edge 14', 'spoter-elementor' ); ?></option>
                                    <option value="Edge/13"><?php esc_html_e( 'Edge 13', 'spoter-elementor' ); ?></option>
                                    <option value="Edge/12"><?php esc_html_e( 'Edge 12', 'spoter-elementor' ); ?></option>
                                    <option value="MSIE 11"><?php esc_html_e( 'Internet Explorer 11', 'spoter-elementor' ); ?></option>
                                    <option value="MSIE 10.6"><?php esc_html_e( 'Internet Explorer 10.6', 'spoter-elementor' ); ?></option>
                                    <option value="MSIE 10.0"><?php esc_html_e( 'Internet Explorer 10.0', 'spoter-elementor' ); ?></option>
                                    <option value="MSIE 10."><?php esc_html_e( 'Internet Explorer 10', 'spoter-elementor' ); ?></option>
                                    <option value="MSIE 9."><?php esc_html_e( 'Internet Explorer 9', 'spoter-elementor' ); ?></option>
                                    <option value="MSIE 8."><?php esc_html_e( 'Internet Explorer 8', 'spoter-elementor' ); ?></option>
                                    <option value="MSIE 7."><?php esc_html_e( 'Internet Explorer 7', 'spoter-elementor' ); ?></option>
                                    <option value="#MSIE [1-6]\.#"><?php esc_html_e( 'Internet Explorer 1-6', 'spoter-elementor' ); ?></option>
                                    <option value="Opera"><?php esc_html_e( 'Opera (All)', 'spoter-elementor' ); ?></option>
                                    <option value="#Opera/(5[1-9]|60)\.#"><?php esc_html_e( 'Opera 51-60', 'spoter-elementor' ); ?></option>
                                    <option value="#Opera/(4[1-9]|50)\.#"><?php esc_html_e( 'Opera 41-50', 'spoter-elementor' ); ?></option>
                                    <option value="#Opera/(3[1-9]|40)\.#"><?php esc_html_e( 'Opera 31-40', 'spoter-elementor' ); ?></option>
                                    <option value="#Opera/(2[1-9]|30)\.#"><?php esc_html_e( 'Opera 21-30', 'spoter-elementor' ); ?></option>
                                    <option value="#Opera/(1[1-9]|20)\.#"><?php esc_html_e( 'Opera 11-20', 'spoter-elementor' ); ?></option>
                                    <option value="#Opera/([1-9]|10)\.#"><?php esc_html_e( 'Opera 1-10', 'spoter-elementor' ); ?></option>
                                    <option value="Safari"><?php esc_html_e( 'Safari (All)', 'spoter-elementor' ); ?></option>
                                    <option value="#Version/11\..*Safari/#"><?php esc_html_e( 'Safari 11', 'spoter-elementor' ); ?></option>
                                    <option value="#Version/10\..*Safari/#"><?php esc_html_e( 'Safari 10', 'spoter-elementor' ); ?></option>
                                    <option value="#Version/9\..*Safari/#"><?php esc_html_e( 'Safari 9', 'spoter-elementor' ); ?></option>
                                    <option value="#Version/8\..*Safari/#"><?php esc_html_e( 'Safari 8', 'spoter-elementor' ); ?></option>
                                    <option value="#Version/7\..*Safari/#"><?php esc_html_e( 'Safari 7', 'spoter-elementor' ); ?></option>
                                    <option value="#Version/6\..*Safari/#"><?php esc_html_e( 'Safari 6', 'spoter-elementor' ); ?></option>
                                    <option value="#Version/5\..*Safari/#"><?php esc_html_e( 'Safari 5', 'spoter-elementor' ); ?></option>
                                    <option value="#Version/4\..*Safari/#"><?php esc_html_e( 'Safari 4', 'spoter-elementor' ); ?></option>
                                    <option value="#Version/[1-3]\..*Safari/#"><?php esc_html_e( 'Safari 1-3', 'spoter-elementor' ); ?></option>
                                </select>
                            </div>
                        </div>

                        <div class="mdp-widget-manager-control-box">
                            <p><?php esc_html_e( 'Mobile Browsers:', 'spoter-elementor' ); ?></p>
                            <div>
                                <!--suppress HtmlFormInputWithoutLabel -->
                                <select class="mobile-browsers chosen-select" multiple="">
                                    <option value=""></option>
                                    <option value="mobile"><?php esc_html_e( 'All', 'spoter-elementor' ); ?></option>
                                    <option value="Android"><?php esc_html_e( 'Android', 'spoter-elementor' ); ?></option>
                                    <option value="#Android.*Chrome#"><?php esc_html_e( 'Android Chrome', 'spoter-elementor' ); ?></option>
                                    <option value="Blackberry"><?php esc_html_e( 'Blackberry', 'spoter-elementor' ); ?></option>
                                    <option value="IEMobile"><?php esc_html_e( 'IE Mobile', 'spoter-elementor' ); ?></option>
                                    <option value="iPad"><?php esc_html_e( 'iPad', 'spoter-elementor' ); ?></option>
                                    <option value="iPhone"><?php esc_html_e( 'iPhone', 'spoter-elementor' ); ?></option>
                                    <option value="iPod"><?php esc_html_e( 'iPod Touch', 'spoter-elementor' ); ?></option>
                                    <option value="NetFront"><?php esc_html_e( 'NetFront', 'spoter-elementor' ); ?></option>
                                    <option value="NokiaBrowser"><?php esc_html_e( 'Nokia', 'spoter-elementor' ); ?></option>
                                    <option value="Opera Mini"><?php esc_html_e( 'Opera Mini', 'spoter-elementor' ); ?></option>
                                    <option value="Opera Mobi"><?php esc_html_e( 'Opera Mobile', 'spoter-elementor' ); ?></option>
                                    <option value="UC Browser"><?php esc_html_e( 'UC Browser', 'spoter-elementor' ); ?></option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="mdp-panel mdp-panel-box mdp-ips mdp-margin <?php $this->is_need_to_hide( 'ip_addresses' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'IP Addresses', 'spoter-elementor' ); ?></h4>
                    ...
                    <div class="mdp-ips-box">
                        <p class="mdp-margin-bottom-remove mdp-margin-top">
                            <?php esc_html_e( 'IP Addresses / Ranges', 'spoter-elementor' ); ?><br>
                        </p>

                        <!--suppress HtmlFormInputWithoutLabel -->
                        <textarea class="mdp-ips-field"></textarea>
                        <p>
                            <?php esc_html_e( 'List of IP addresses or IP ranges. Example: ', 'spoter-elementor' ); ?><br>
                            <?php esc_html_e( '46.33.233.31', 'spoter-elementor' ); ?><br>
                            <?php esc_html_e( '46.0-46.1', 'spoter-elementor' ); ?><br>
                            <?php esc_html_e( '46', 'spoter-elementor' ); ?>
                        </p>
                    </div>
                ...
                <div class="mdp-panel mdp-panel-box mdp-php mdp-margin <?php $this->is_need_to_hide( 'custom_php' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Custom PHP', 'spoter-elementor' ); ?></h4>
                    ...
                    <div class="mdp-php-box">
                        <p class="mdp-margin-bottom-remove mdp-margin-top">
							<?php esc_html_e( 'Enter a piece of PHP code to evaluate. The code must return the value true or false.', 'spoter-elementor' ); ?>
                            <br>
							<?php esc_html_e( 'For instance:', 'spoter-elementor' ); ?>
                        </p>
