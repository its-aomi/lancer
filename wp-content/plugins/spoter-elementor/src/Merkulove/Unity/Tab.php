...
abstract class Tab {
    ...
    protected function do_settings_base( $tab_slug = null ) {
        ...
        settings_fields( 'SpoterElementor' . $tab_slug . 'OptionsGroup' );
        do_settings_sections( 'SpoterElementor' . $tab_slug. 'OptionsGroup' );
    ...
    protected function add_settings_base( $tab_slug = null ) {
        ...
        /** Status Tab. */
        register_setting( 'SpoterElementor' . $tab_slug . 'OptionsGroup', 'mdp_spoter_elementor_' . $tab_slug . '_settings' );
        add_settings_section( 'mdp_spoter_elementor_' . $tab_slug . '_page_status_section', '', null, 'SpoterElementor' . $tab_slug . 'OptionsGroup' );
