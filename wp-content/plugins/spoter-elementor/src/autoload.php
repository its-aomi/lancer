...
final class Autoload {
    ...
    public static function load( $class ) {
        ...
        /** Classes from Spoter for Elementor. */
        $file_p = self::get_plugin_class_file( $class );

        /** If Class exists in Spoter for Elementor - load it. */
    ...
    private static function get_unity_class_file( $class ) {
        ...
        return $file . self::$DS . str_replace( ['SpoterElementor\\', '\\'], ['', self::$DS], $class ) . '.php';

    }

    /**
     * Build file path for classes from Spoter for Elementor directory.
     *
     * @param string $class - Called class name.
     *
     * @static
